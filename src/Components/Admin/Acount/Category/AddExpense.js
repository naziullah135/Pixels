...
import { ModalPostMethodHook, deleteMethod, updateMethodHook } from '../../../../../lib/usePostHooks';
import { base_url_v2 } from '../../../../../lib/helper';
import CustomButtonLoading from '../../../../Shared/CustomButtonLoading';
import swal from 'sweetalert';

const AddExpense = ({ setAddExpenseModalOpen, amount, title, id,rowrefetch }) => {
  ...
  useEffect(() => {
    ...
    const { data: categories, isLoading, refetch } = useFetchVersionTwo(["expense-category"], "expense-category")
    ...
    const addExpense = (data) => {
        ...
        if (amount > acountblance) {
            ...
            updateMethodHook(updateUrl, updateBody, rowrefetch)
            ModalPostMethodHook(url, body, rowrefetch, setLoading, setAddExpenseModalOpen)
          }
    }
    ...
    return (
        <div className='w-[320px] sm:w-[630px] md:w-[700px]'>
            <form onSubmit={handleSubmit(addExpense)} className=' my-5'>
                <h1 className='text-xl font-bold mb-7'>Add Expenses</h1>
