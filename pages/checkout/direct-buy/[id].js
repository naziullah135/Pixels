...
const DirectBuy = () => {
  ...
  const productUrl = `https://server-journalshop.vercel.app/api/v1/product/${id}`;
      ...
      <div className="bg-accent">
        <div className="mid-container">
          ...
          <form onSubmit={handleSubmit(onSubmitForm)}>
            <div className=" block md:grid grid-cols-5 justify-center gap-5 py-5">
              ...
              <div className="w-full md:col-span-2 bg-white rounded-xl shadow p-5 relative">
                {/* {
                  (inputSize || userColor) && <p className="text-primary mb-2 font-bold">প্রডাক্ট এর সাইজ বাটনে ক্লিক করে সাইজ সিলেক্ট করুন |</p>
                } */}
